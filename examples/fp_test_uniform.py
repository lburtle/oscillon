...
from oscillon.graph import NetworkSpec, MotifSpec

N = 3
dt, n_steps, burn_in = 0.1, 2000, 500  # long burn_in: let transient die, judge the tail
...
cycle = NetworkSpec([MotifSpec.dense(N)])
key, sub = jax.random.split(key)
params0 = init_params_asymmetric(spec, sub)
x0 = jnp.full((N,), 0.1)
