...
from oscillon.topology import (
    ...
    make_block_param_to_model_uniform_theta,
    init_params_asymmetric_uniform_theta,
)
...
params0 = init_params_asymmetric_uniform_theta(spec, sub, z_std=2.0)

x0 = jnp.full((N,), 0.1)

# --- measure the warm-start cycle period, build target to match ---
t = jnp.arange(n_steps) * dt
p2m = make_block_param_to_model_uniform_theta(spec)
W0, th0 = p2m(params0)
...
from phase_grid_uniform import plot_phase_grid
...
if N == 3:
    ...
    before_3 = plot_phase_portrait(
        ...
        save_path="images/phase_portraits/3-cycle_uniform_phase_before.png",
    )
    ...
    after_3 = plot_phase_portrait(
        ...
        save_path="images/phase_portraits/3-cycle_uniform_phase_after.png",
    )
    ...
    before_3_grid = plot_phase_grid(
        ...
        x0s=x0s,
        title="3-cycle phase portrait (before)",
        save_path="images/phase_portraits/3-cycle_uniform_grid_before.png",
    )
    ...
    after_3_grid = plot_phase_grid(
        ...
        x0s=x0s,
        title="3-cycle phase portrait (after)",
        save_path="images/phase_portraits/3-cycle_uniform_grid_after.png",
    )
    ...
    before_n = plot_phase_portrait(
        ...
        save_path=f"images/phase_portraits/{N}-cycle_uniform_phase_before.png",
    )
    ...
    after_n = plot_phase_portrait(
        ...
        x0s=[x0],
        title=f"N={N} limit cycle (PCA projection)",
        save_path=f"images/phase_portraits/{N}-cycle_uniform_phase_after.png",
    )
    ...
    before_n_grid = plot_phase_grid(
        ...
        save_path=f"images/phase_portraits/{N}-cycle_grid_uniform_before.png",
    )
    ...
    after_n_grid = plot_phase_grid(
        ...
        x0s=[x0],
        title=f"N={N} limit cycle (slices)",
        save_path=f"images/phase_portraits/{N}-cycle_uniform_grid_after.png",
    )
...
def run_sweep(n_seeds=20, z_std=2.0):
    ...
    with open(out / "ablation_hyperparams_soft.json", "w") as f:
    ...
    for seed in range(n_seeds):
        for z_std in [1.0, 2.0, 3.0]:
            ...
            params0_s = init_params_asymmetric_uniform_theta(spec, sub_s, z_std=z_std)
